...
* @param {Function} callback - callback with (err, client, db)
*/
Connection.prototype.getNativeClient = function (callback) {
    ...
    if (this._nativeClient && this._nativeDb) {
        return callback(null, this._nativeClient, this._nativeDb);
    }
    
    // Create new client connection
    MongoClient.connect(this.uri, this.options, function (err, client) {
        ...
        callback(null, self._nativeClient, self._nativeDb);
    });
};
